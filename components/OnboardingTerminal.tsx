...
export function OnboardingTerminal({ onComplete }: OnboardingTerminalProps) {
    ...
    const buttonBaseStyle = "relative p-8 md:p-10 border transition-all duration-400 rounded-xl text-left shadow-xl overflow-hidden";

    // Stile per l'elemento non cliccabile
    const disabledStyle = "opacity-50 cursor-not-allowed grayscale";
    const disabledButtonBaseStyle = "group relative p-8 md:p-10 border transition-all duration-400 rounded-xl text-left shadow-xl overflow-hidden";
